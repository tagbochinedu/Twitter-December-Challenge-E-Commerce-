...
const HomePageGrid = () => {
  return (
    <>
      ...
      <div className="flex items-center justify-start md:justify-between mb-7 lg:mb-0">
        <div className="relative flex w-4/12 mr-10">
          <img src={img1} alt="person" className="w-10 lg:w-auto relative" />
          <img src={img2} alt="person" className="w-10 lg:w-auto absolute z-10 left-[23px] lg:left-[30px]" />
          <img src={img3} alt="person" className="w-10 lg:w-auto absolute z-20 left-[46px] lg:left-[60px]" />
          <img src={img4} alt="person" className="w-10 lg:w-auto absolute z-30 left-[69px] lg:left-[90px]" />
          <img src={img5} alt="person" className="w-10 lg:w-auto absolute z-40 left-[92px] lg:left-[120px]" />
        </div>
        <div className="relative w-6/12 lg:w-4/12">
          <p className="font-satoshi font-semibold lg:font-medium text-sm lg:text-xl text-start">64 major creators</p>
        </div>
