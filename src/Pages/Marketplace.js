      ...
      <div className="w-3/12">
        <form className="flex justify-between bg-[#F4F2F2] justify-center py-2 pl-6 pr-0 rounded-xl">
          <svg
            ...
            strokeWidth="1.5"
            stroke="currentColor"
            className="w-2/12 h-auto text-[#999999]"
          >
            <path
              strokeLinecap="round"
          ...
          <input
            type="text"
            className="w-9/12 bg-[#F4F2F2] px-2 focus:outline-0"
            placeholder="Search..."
          />
        </form>
        <div>
          <div className="flex lg:mt-24 lg:mb-3">
            <svg
              viewBox="0 0 36 40"
              fill="none"
              xmlns="http://www.w3.org/2000/svg"
            ...
            <h3 className="lg:text-3xl font-satoshi font-medium lg:ml-6">
              Filter
            </h3>
          </div>
