          ...
          <div key={product.id}>
            ...
            <div className="flex">
              ...
              <div className="border-[#333333] border-[1px] w-6/12">
                <div className="flex justify-between items-center px-7 py-7 border-b-[#333333] border-b-[1px]">
                  <h4 className="font-satoshi lg:font-semibold lg:text-3xl lg:leading-[44px] capitalize">
                    {product.title}
                  </h4>
                  <p className="font-stix lg:text-3xl flex items-center">
                    <svg
                      width="33"
                      height="42"
                      viewBox="0 0 33 42"
